...
public class YPYRemoteControlClientCompat {

    private static final String TAG = YPYRemoteControlClientCompat.class.getSimpleName();
    ...
    static {
        try {
            ClassLoader classLoader = YPYRemoteControlClientCompat.class.getClassLoader();
            ...
            // change
            // in future versions.
            for (Field field : YPYRemoteControlClientCompat.class.getFields()) {
                try {
    ...
    public YPYRemoteControlClientCompat(PendingIntent pendingIntent) {
    ...
    public YPYRemoteControlClientCompat(PendingIntent pendingIntent, Looper looper) {
        if (!sHasRemoteControlAPIs) {
            return;
        }
     ...
     *
     * @param startEmpty Set to false if you want the MetadataEditor to contain the
