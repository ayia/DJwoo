...
public class YPYAudioFocusHelper implements AudioManager.OnAudioFocusChangeListener {

    private AudioManager mAM;
    private IMusicFocusableListener mFocusable;

    public YPYAudioFocusHelper(Context ctx, IMusicFocusableListener focusable) {
