...
public class YPYEqualizerActivity extends YPYFragmentActivity implements IDBMusicPlayerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvBass = (TextView) findViewById(R.id.tv_bass);
        mTvBass.setTypeface(mTypefaceBold);

        mTvEqualizer = (TextView) findViewById(R.id.tv_equalizer);
        mTvEqualizer.setTypeface(mTypefaceBold);

        mTvVirtualizer = (TextView) findViewById(R.id.tv_virtualizer);
        mTvVirtualizer.setTypeface(mTypefaceBold);

        mTvInfoVirtualizer = (TextView) findViewById(R.id.tv_info_virtualizer);
        mTvInfoVirtualizer.setTypeface(mTypefaceNormal);

        mTvInfoBass = (TextView) findViewById(R.id.tv_info_bass);
        mTvInfoBass.setTypeface(mTypefaceNormal);

        mLayoutBassVir = (LinearLayout) findViewById(R.id.layout_bass_vir);

        mCircularBass = (SeekArc) findViewById(R.id.seekBass);
        ...
        mCircularVir = (SeekArc) findViewById(R.id.seekVir);
        ...
        mSwitchBtn.setOncheckListener(new SwitchView.OnCheckListener() {
            @Override
    ...
    private void setupEqualizerFxAndUI(boolean isFirstTime) {
        ...
        DBLog.d(TAG, "==========>deltaTime=" + String.valueOf((System.currentTimeMillis() - pivotTime) / 1000));
    ...
    private void setUpPresetName() {
        ...
        if (mEqualizer != null) {
            ...
            if (numberPreset > 0) {
                ...
                dataAdapter.setPresetListener(new PresetAdapter.IPresetListener() {
                    @Override
                    public void onSelectItem(int position) {
                        mSpinnerPresents.setSelection(position);
                    }
                });
